    ...
    return (
        <header className="flex items-center justify-between p-2 bg-gray-800 border-b border-gray-700 text-center">
            ...
            <div className="flex items-center gap-2 sm:absolute sm:left-1/2 sm:-translate-x-1/2">
                <h1 className="text-lg max-sm:text-sm">Problem (08/31): I Want My Youth Back</h1>
...
function Problem({ solved, setSolved }: { solved: boolean, setSolved: React.Dispatch<React.SetStateAction<boolean>> }) {
    ...
    const [code, setCode] = useState<string>(
        `// Write a function 'calculateAge' that takes two arguments:
// - 'earthAge': your age in Earth years
// - 'planet': a string representing a planet
// The function should return your age in the years of the given planet.
// Assume the following orbital periods relative to Earth:
...
// Example usage:
// const age = calculateAge(30, 'Earth'); // Output: 30 (approximately)
// const age = calculateAge(30, 'Saturn'); // Output: 1 (approximately)

function calculateAge(earthAge, planet) {
    // Your code here
}`
    );
    ...
    const testCases = [
        {
            input: 'return calculateAge(30, "Mercury");',
            output: "125"
        },
        {
            input: 'return calculateAge(30, "Venus");',
            output: "48"
        },
        {
            input: 'return calculateAge(30, "Mars");',
            output: "16"
        },
        {
            input: 'return calculateAge(30, "Jupiter");',
            output: "3"
        },
    ];
