...
function Problem({ solved, setSolved }: { solved: boolean, setSolved: React.Dispatch<React.SetStateAction<boolean>> }) {
    ...
    const [code, setCode] = useState<string>(
        `// Write a function 'sortConstellations' that takes an array of strings as input,
// each string representing a constellation name.
// The function should return the constellation names sorted alphabetically,
// but with all the vowel letters removed.

// Example usage:
// const constellations = ['Alpha Centauri', 'Betelgeuse', 'Canis Major'] // Output: ['lph', 'Btlgs', 'Cns Mjr']

function sortConstellations(constellations) {
    // Your code here
}`
    );
    ...
    const testCases = [
        {
            input: 'return sortConstellations(["Alpha Centauri", "Betelgeuse", "Canis Major"])',
            output: "['lph', 'Btlgs', 'Cns Mjr']"
        },
        {
            input: 'return sortConstellations(["Orion", "Polaris", "Sirius"]);',
            output: "['rn', 'Plrs', 'Srs']"
        },
        {
            input: 'return sortConstellations(["Andromeda", "Centaurus", "Eridanus"]);',
            output: "['ndrmd', 'Cntrs', 'rdns']"
        },
        {
            input: 'return sortConstellations(["Cassiopeia", "Draco", "Pegasus"]);',
            output: "['ssp', 'Drc', 'Pgss']"
        },
    ];
